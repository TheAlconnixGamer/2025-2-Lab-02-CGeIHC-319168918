...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[2].SetFlash(worldPos, worldDir);
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-20 + mainWindow.getHelicop2(), 35.0f, mainWindow.getHelicop1()));
		...
		//Luz Helicoptero
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 34.8f, -5.0f));
		worldPos = glm::vec3(model[3]);
		worldDir = glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.8f, -1.0f, 0.0f)));
